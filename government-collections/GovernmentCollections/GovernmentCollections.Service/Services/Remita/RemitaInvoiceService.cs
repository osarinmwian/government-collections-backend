...
public class RemitaInvoiceService : IRemitaInvoiceService
{
    ...
    private readonly IRemitaAuthService _authService;

    public RemitaInvoiceService(HttpClient httpClient, IConfiguration configuration, IRemitaAuthService authService)
    {
