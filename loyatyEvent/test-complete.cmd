...
curl -X POST http://localhost:5000/api/transactions/process ^
  -H "Content-Type: application/json" ^
  -H "X-API-Key: KBL-7f9d4a2e8b1c6f3a9e5d2b8c4f7a1e6d9b3c8f2a5e7d1b4c9f6a3e8d2b5c7f0a4e9d" ^
  -d "{\"accountNumber\":\"12338849440\",\"amount\":1500,\"transactionType\":\"BILL_PAYMENT\"}"
echo.
echo.
...
curl -X POST http://localhost:5000/api/transactions/process ^
  -H "Content-Type: application/json" ^
  -H "X-API-Key: KBL-7f9d4a2e8b1c6f3a9e5d2b8c4f7a1e6d9b3c8f2a5e7d1b4c9f6a3e8d2b5c7f0a4e9d" ^
  -d "{\"accountNumber\":\"12338849440\",\"amount\":5000,\"transactionType\":\"NIP_TRANSFER\"}"
echo.
echo.
...
echo Step 5: Test Invalid Transaction Type (Should show error)
curl -X POST http://localhost:5000/api/transactions/process ^
  -H "Content-Type: application/json" ^
  -H "X-API-Key: KBL-7f9d4a2e8b1c6f3a9e5d2b8c4f7a1e6d9b3c8f2a5e7d1b4c9f6a3e8d2b5c7f0a4e9d" ^
  -d "{\"accountNumber\":\"12338849440\",\"amount\":1000,\"transactionType\":\"airtime\"}"
echo.
echo.

echo Step 6: Test Redemption (Redeem 3 points)
curl -X POST http://localhost:5000/api/loyalty/redeem-points ^
  -H "Content-Type: application/json" ^
  -H "X-API-Key: KBL-7f9d4a2e8b1c6f3a9e5d2b8c4f7a1e6d9b3c8f2a5e7d1b4c9f6a3e8d2b5c7f0a4e9d" ^
  -d "{\"accountNumber\":\"12338849440\",\"pointsToRedeem\":3,\"redemptionType\":\"CASH\",\"username\":\"testuser\"}"
echo.
echo.

echo Step 7: Final Dashboard Check (Should show 3 points)
curl -X GET http://localhost:5000/api/loyalty/dashboard/USER123 ^
  -H "X-API-Key: KBL-7f9d4a2e8b1c6f3a9e5d2b8c4f7a1e6d9b3c8f2a5e7d1b4c9f6a3e8d2b5c7f0a4e9d"
echo.
echo.
